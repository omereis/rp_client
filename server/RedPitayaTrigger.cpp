...
//-----------------------------------------------------------------------------
rp_acq_trig_src_t TRedPitayaTrigger::GetHardwareTriggerSource () const
{
...
//-----------------------------------------------------------------------------
std::string TRedPitayaTrigger::ReadHardwareTriggerSource ()
{
	rp_acq_trig_src_t trigger_src;

	rp_AcqGetTriggerSrc(&trigger_src);
	return (HardwareTriggerSourceName (trigger_src));
}

//-----------------------------------------------------------------------------
std::string TRedPitayaTrigger::HardwareTriggerSourceName (rp_acq_trig_src_t trigger_src)
{
	//rp_acq_trig_src_t trigger_src;
	std::string strSource;
...
void TRedPitayaTrigger::PrintHardwareSetup (FILE *file)
{
	...
	fprintf (file, "    Source: %s\n", ReadHardwareTriggerSource ().c_str());
	//fprintf (stderr, "======================================================\n");
}
